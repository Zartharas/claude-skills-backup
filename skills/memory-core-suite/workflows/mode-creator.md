...
Read [references/mode-authoring.md](assets/mode-creator/references/mode-authoring.md) before drafting.
...
- Read [references/telegram.md](assets/mode-creator/references/telegram.md), then guide new users through BotFather and the secure setup helper.
...
```bash
node <skill-directory>/assets/mode-creator/scripts/install-mode.mjs \
...
```bash
node <skill-directory>/assets/mode-creator/scripts/configure-telegram.mjs \
