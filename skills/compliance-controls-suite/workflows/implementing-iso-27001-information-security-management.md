...
Use to establish, operate, audit, or improve an ISO/IEC 27001:2022 ISMS: context, leadership, risk treatment, Statement of Applicability, controls, evidence, internal audit, management review, and improvement. Trigger for implementation or certification preparation. Do not claim certification or conformity without audit evidence and certification-body action.
...
_Source workflow alias: implementing-iso-27001-information-security-management. Condensed from the validated Codex source for the ChatGPT Web edition; executable examples and local-only artifacts were intentionally omitted._